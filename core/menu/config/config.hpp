...
public:
	...
	struct {
		...
		bool player_flags_nigga{ false };
		bool player_flags_nigga2{ false };
		int player_box{ 0 };
		...
		bool grief_enable{ false };
		bool vis_chams_vis_teammate{ false };
		bool sleevechams{ false };
		bool handchams{ false };
		bool weaponchams{ false };
		bool vis_chams_invis_teammate{ false };
		int weaponchamcombo{ 0 };
		float weaponchamscolor[4]{ 1.0f,1.0f,1.0f,1.0f };
		float clr_chams_vis_teammate[4]{ 1.0f,1.0f,1.0f,1.0f };
		float sleevescolor[4]{ 1.0f,1.0f,1.0f,1.0f };
		float handscolor[4]{ 1.0f,1.0f,1.0f,1.0f };
		...
		int attack2spam_key{ 0 };
		bool doorspam_enabled{ false };
		bool attack2spam{ false };
		bool name_spam{ false };
		bool blockbot{ false };
		int blockbot_key{ 0 };
		bool niggatag{ false };
